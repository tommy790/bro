...
ENT.DisplayName = "EF1 Tornado"
ENT.PrintName = "XTwisters3 EF1 Tornado"

local Tornadoes = {
    {ParticleName = "RDS_XT1_EF1_A1", VortexSize = 300, VortexSwirlRatio = {Min = 1, Max = 3}, StrengthenParams = {WindspeedFadeStart = 0, WindspeedFadeEnd = 30, VortexStartSize = 300, SizeFadeStart = 15, SizeFadeEnd = 110}};
    {ParticleName = "trt_tornado_2", VortexSize = 700, VortexSwirlRatio = {Min = 0.25, Max = 0.7}, StrengthenParams = {WindspeedFadeStart = 0, WindspeedFadeEnd = 55, VortexStartSize = 700, SizeFadeStart = 15, SizeFadeEnd = 110}};
...
function ENT:Initialize()
    ...
    if SERVER then
        ...
        self.VortexWindspeed = SuperRandom(86, 110)
    ...
    elseif CLIENT then
        ...
        language.Add("xt3_tornadoes_ef1", "EF1 Tornado")
        killicon.Add("xt3_tornadoes_ef1", "materials/KillIcons/EF1KillIcon.png", Color(255, 255, 255))
    end
end
