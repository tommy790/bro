...
local function populate()
    spawnmenu.AddToolMenuOption("V-NPCs", "Personalization", "vnpcs_settings", "Settings", "", "", function(panel)
        ...
        panel:Help("Each alive prey pushes a silhouette (head, shoulders, hips, feet) on the GPU hull.")
        panel:Help("Swallowing is a peristalsis wave along the neck/chest. Pregnancy sits high/round; swallowed prey sits low/heavy. Hide Belly Entity turns off the old belly model while the GPU mesh is drawing.")
