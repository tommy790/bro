...
local function populate()
    spawnmenu.AddToolMenuOption("V-NPCs", "Personalization", "vnpcs_settings", "Settings", "", "", function(panel)
        ...
        panel:Help("\nDynamic Mesh Deform & Ragdoll Matrix\n")
        panel:CheckBox("Dynamic Weight Painting (shape-aware belly)", "vnpcs_traits_enabled")
        panel:ControlHelp("Lets traits (Metabolism, Acid Resistance, Max Capacity, Stamina Penalty) affect digestion.")
        panel:CheckBox("Ragdoll Matrix (physics-driven digestion)", "vnpcs_ragdoll_matrix")
        panel:ControlHelp("Simulates live struggling inside the belly, driving jostle/bounce and pushing nearby physics.")
        panel:CheckBox("Ragdoll Matrix world collision", "vnpcs_ragdoll_collision")
        panel:ControlHelp("Lets a struggling belly gently shove nearby players/props, like it's actually solid.")
        panel:NumSlider("Ragdoll Matrix force multiplier", "vnpcs_ragdoll_force", 0, 4, 2)

        panel:Help("\nSmart Nextbot AI & Navigation Mesh\n")
        panel:CheckBox("Smart AI Enabled", "vnpcs_smart_ai")
        panel:CheckBox("Pack Hunting (flank/surround)", "vnpcs_smart_ai_packhunt")
        panel:CheckBox("Ambush Behaviour", "vnpcs_smart_ai_ambush")
        panel:CheckBox("Sound/Flashlight Tracking", "vnpcs_smart_ai_hearing")
        panel:CheckBox("Use Navigation Mesh", "vnpcs_smart_ai_navmesh")
        panel:ControlHelp("Requires the map to have a generated .nav file (nav_generate).")
