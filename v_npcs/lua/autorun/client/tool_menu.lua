...
local function populate()
    ...
    spawnmenu.AddToolMenuOption("V-NPCs", "Personalization", "vnpcs_personality", "Personality", "", "", function(panel)
        ...
        panel:Help("\nPrey Type Attraction\n")
        panel:CheckBox("Enable Prey Type Attraction", "vnpcs_prey_attraction_enabled")
        panel:NumSlider("Hunt Threshold", "vnpcs_prey_attraction_threshold", 0, 100, 0)
        panel:NumSlider("Desperate Hunger %", "vnpcs_prey_attraction_desperate_hunger", 0, 100, 0)
        panel:CheckBox("Show Attraction Overlay", "vnpcs_prey_attraction_debug")
        panel:Help("Each predator is attracted to 1-3 prey types (human, combine, zombie, headcrab, antlion, vortigaunt, animal, player, predator, corpse). They hunt favorites first and only ignore preferences when starving or badly hurt.")
