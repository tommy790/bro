...
local function populate()
    spawnmenu.AddToolMenuOption("V-NPCs", "Personalization", "vnpcs_settings", "Settings", "", "", function(panel)
        ...
        panel:Help("Each alive prey pushes 4 unique lumps (head, torso, left limb, right limb) on the generated GPU belly mesh.")
        panel:Help("While swallowing, a GPU mesh lump travels neck -> upper chest. Bigger prey (model scale / body width) makes a thicker bulge.")
