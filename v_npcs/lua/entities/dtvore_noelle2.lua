...
ENT.PrintName = "LW Noelle (DT Pack)"
ENT.Category = "Vore"

--THIS IS THE MODEL!
ENT.Models = {"models/CryptiaCurves/Deltarune/Stylized_Noelle_Holiday_Casual_PM.mdl"}
ENT.ModNeeded = "https://steamcommunity.com/sharedfiles/filedetails/?id=3533610056"
ENT.SpawnHealth = 100

ENT.BellyColor = Color(204,123,117)
